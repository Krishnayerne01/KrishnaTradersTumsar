...
def view_category(request):
    ...
    return render(request, 'view_category.html', locals())#locals is used to iterate using variable category

def edit_category(request, pid): #in other we use only request but here we use pid beacause we want to work on sinhgle data
    if not request.user.is_staff:
        return redirect('admin_login')
...
#no need to write html for delete category
